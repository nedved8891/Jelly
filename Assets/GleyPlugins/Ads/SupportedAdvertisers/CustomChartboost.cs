namespace GleyMobileAds
{
    ...
    public class CustomChartboost : MonoBehaviour, ICustomAds
    {
        ...
        /// <summary>
        /// called with delay to reload an interstitial after the previos one failed to load
        /// </summary>
        ...
        /// <summary>
        /// called with delay to reload a rewarded video after the previos one failed to load
        /// </summary>
        void ReloadVideoCB()
        {
        ...
        /// <summary>
        /// Chartboost specifie event triggered after a rewarded video was fully watched
        /// </summary>
        /// <param name="arg1"></param>
        /// <param name="arg2"></param>
