namespace GleyMobileAds
{
    ...
    public class CustomAdColony : MonoBehaviour, ICustomAds
    {
        ...
        string rewardedZoneId;
        int maxRetryCount = 10;
        int currentRetryRewardedVideo;
        int currentRetryInterstitial;
        bool debug;
        ...
        public void InitializeAds(GDPRConsent consent, List<PlatformSettings> platformSettings)
        {
            ...
            string[] zoneIDs = new string[] { interstitialZoneId, rewardedZoneId };
        ...
        private void OnRequestInterstitialFailed(string zoneID)
        {
            if (debug)
            {
                Debug.Log(this + " Load Ad Faild");
                ScreenWriter.Write(this + " Load Ad Faild");
            }
