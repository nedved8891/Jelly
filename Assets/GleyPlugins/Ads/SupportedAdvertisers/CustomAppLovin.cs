    ...
    public class CustomAppLovin : MonoBehaviour, ICustomAds
    {
        ...
        private void onAppLovinEventReceived(string ev)
        {
            ...
            if (ev.Contains("REWARDAPPROVEDINFO"))
            {
                if (debug)
                {
                    Debug.Log(this + " rewarded videw was completed");
                    ScreenWriter.Write(this + " rewarded videw was completed");
                }
        ...
        /// <summary>
        /// preload an interstitial ad befre showing
        /// if it failes for maxRetryCount times do not try anymore
        /// </summary>
        ...
        /// <summary>
        /// preload a rewarded video ad befre showing
        /// if it failes for maxRetryCount times do not try anymore
        /// </summary>
